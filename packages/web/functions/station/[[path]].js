 ...
 *
 * Unknown stations return a clean 404 (the collector 404s). Bounded to
 * /station/* by handleArchiveRequest's URL matching — _routes.json is include
 * "/*" and scopes nothing (audit5 M9).
 */
