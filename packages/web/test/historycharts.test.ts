...
const HISTORY: HistoryResponse = {
  ...
  daily: [
    ...
    { date: '2026-08-03', count: 3, cancellations: 1, delays: 2, alerts: 0 },
    { date: '2026-08-04', count: 0, cancellations: 0, delays: 0, alerts: 0 },
    { date: '2026-08-05', count: 0, cancellations: 0, delays: 0, alerts: 0 },
    { date: '2026-08-06', count: 6, cancellations: 0, delays: 6, alerts: 0 },
  ],
  by_line: [],
  by_cause: [],
  by_hour: [],
